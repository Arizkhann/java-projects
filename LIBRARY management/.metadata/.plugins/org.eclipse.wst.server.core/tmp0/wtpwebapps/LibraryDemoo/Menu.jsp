...
<%
  ...
  out.println("Welcome Ariz <b>" +user+"</b>");
  
%>
<br/><br/><br/><br/>
<div class="logout">
<input type="button" name="logout" value="Logout" onclick="window.location='index.html'"><br/><br/>
</div>
<div class="aone" style =" background-color:#ff11ff ">
<div class= "atwo" style =" background-color:#ff11ff ">
