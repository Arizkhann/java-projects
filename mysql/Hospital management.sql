...
INSERT INTO PatientReports (PatientId, TestCode, TestName, TestDescription, Cost, Comments) 
VALUES 
('P001', 'T123', 'Blood Test', 'Complete blood count', 75.00, 'No specific comments'),
('P002', 'T456', 'Urinalysis', 'Urine analysis for kidney function', 60.50, 'Normal results'),
('P003', 'T789', 'X-Ray', 'Chest X-Ray', 120.00, 'Follow-up needed');
