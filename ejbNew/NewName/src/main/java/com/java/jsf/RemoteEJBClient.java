...
public class RemoteEJBClient {
	...
	private static Context createInitialContext() throws NamingException {
	   ...
	   private static TestCalcRemote lookupRemoteStatelessCalculator() throws NamingException {
	    ...
	    //    final String appName = "";
	      ...
	      //  final String moduleName = "EJBModule";
	        ...
	        final String beanName = "TestCalc";
	        System.out.println(beanName);
	        // the remote view fully qualified class name
	   //     System.out.println(RemoteCalculator.class.getName());
	        final String viewClassName = TestCalcRemote.class.getName();
	        // let's do the lookup
	     ...
	     //   return (RemoteCalculator) context.lookup("ejb:" + appName + "/" + moduleName + "/" + distinctName + "/" + beanName + "!" + viewClassName);
          ...
          //  String distinctName = "";
           ...
           // String viewClassName = RemoteCalculator.class.getName();
            return (TestCalcRemote) ctx.lookup("ejb:" 
              + appName + "/" + moduleName 
              + "/" + distinctName + "/" + beanName + "!" + viewClassName);
	    }
	 private static void invokeStatelessBean() throws NamingException {
	        // Let's lookup the remote stateless calculator
	        final TestCalcRemote statelessRemoteCalculator = lookupRemoteStatelessCalculator();
